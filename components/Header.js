  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-5 px-5 md:px-10">
      ...
      <div className="flex items-center justify-end space-x-4 text-gray-500">
        <p className="hidden md:inline cursor-pointer text-xs lg:text-lg">
          Become a host
        </p>
        <GlobeAltIcon className="hidden md:inline h-6 cursor-pointer" />

        <div className="flex items-center space-x-2 border-2 p-2 rounded-full">
          <MenuIcon className="h-4 md:h-6 cursor-pointer" />
          <UserCircleIcon className="h-4 md:h-6 cursor-pointer" />
        </div>
      </div>
